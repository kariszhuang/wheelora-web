...
export const aiTones = [
  {
    ...
    color: "#6B7280",
    description:
      "Direct, grounded, no-nonsense. No fluff. Titles are straight, options are factual.",
  },
  {
    id: "friendly",
    label: "Friendly",
    ...
    color: "#10B981",
    description:
      "Chill, cozy, and a bit goofy. Feels like a warm hug with puns and playful tone.",
  },
  {
    id: "funny",
    label: "Funny",
    ...
    color: "#F59E0B",
    description:
      "Silly, punchy, and full of LOLs. Titles overreact, options are chaotic truth bombs. Zero filter, full fun.",
  },
  {
    id: "inspirational",
    label: "Inspirational",
    ...
    color: "#F43F5E",
    description:
      "Motivational anime coach vibes. Every option glows with meaning. Titles feel like fate.",
  },
  {
    id: "unhinged",
    label: "Chaotic",
    ...
    color: "#EF4444",
    description:
      "Gremlin mode. Manic energy. Break rules, use chaos for comedy. Weights go brrrr.",
  },
  {
    id: "sarcastic",
    label: "Sarcastic",
    ...
    color: "#FBBF24",
    description:
      "Dry, ironic, judgmental with a smirk. Fake-nice titles. Options roast softly.",
  },
];
...
export const lifeAreas = [
  {
    title: "Food & plans",
    copy: "Ask AI for better dinner ideas, then spin without doomscrolling every restaurant in town.",
  },
  {
    title: "Work & study",
    copy: "Generate smarter focus wheels, tone-shift them, and keep your next step obvious.",
  },
  {
    title: "Friends & dates",
    copy: "Turn indecision into a playful group moment instead of another thirty-message thread.",
  },
  {
    title: "Home & routine",
    copy: "Create low-effort wheels for resets, chores, and everyday tasks you keep re-negotiating.",
  },
  {
    title: "Shopping & money",
    copy: "Build buy-or-skip wheels with AI phrasing that keeps impulse and regret in check.",
  },
];
...
export const faqs = [
  ...
  },
  {
    ...
    a: "Free includes core usage. If you hit free AI limits, rewarded unlocks can add bonus usage. Pro is designed for heavier daily decision volume.",
  },
  {
